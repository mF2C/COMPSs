...
public class ResourceManagerTest {
    ...
    public void testOneCloudWorkersOperations() {
        ...
        ResourceManager.reduceDynamicWorker(cmw1, new PendingReduction<>(reduction1, null));
    ...
    public void testMultipleCloudWorkersOperations() {
        ...
        ResourceManager.reduceDynamicWorker(cmw2, new PendingReduction<>(reduction2, null));
        ...
        ResourceManager.reduceDynamicWorker(cmw3, new PendingReduction<>(reduction4, null));
        ...
        ResourceManager.reduceDynamicWorker(cmw3, new PendingReduction<>(reduction3, null));
